...
public class Ex02 {
   public static void main(String[] args) {
      try {
         ...
         for (Element movie : list) {
            ...
            if (poster != null ) {
               ...
               Thread.sleep(2000);  //여기서 잠시 멈추세요라는 뜻
            }
      ...
      //getImage("https://img1.daumcdn.net/thumb/C408x596/?fname=https%3A%2F%2Ft1.daumcdn.net%2Fmovie%2F765e5c2d68e213449f1018a6197053343ff030b2");
